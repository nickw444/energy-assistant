...
from energy_assistant.lib.home_assistant import HomeAssistantConfig, HomeAssistantStateDict
...
from energy_assistant.models.plant import GridConfig, PlantConfig
