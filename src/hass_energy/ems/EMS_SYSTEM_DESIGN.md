...
- `charge_grid_cost_per_kwh`, `charge_pv_cost_per_kwh`
- `discharge_grid_cost_per_kwh`, `discharge_load_cost_per_kwh`
...
4. **Battery wear cost**:
   - `charge_grid_cost_per_kwh * grid_charge + charge_pv_cost_per_kwh * pv_charge`.
   - `discharge_grid_cost_per_kwh * battery_export + discharge_load_cost_per_kwh * battery_load`.
